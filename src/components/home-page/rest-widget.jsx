    ...
    <section className="bg-white py-16" id="widget">
      <div className="container max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          ...
          {/* Информационная плашка про 2 суток */}
          <div className="inline-flex items-center justify-center gap-2 bg-green-50 border border-green-200 text-green-800 px-5 py-2.5 rounded-2xl text-sm sm:text-base font-medium">
            <svg
            ...
            <span>
              Обратите внимание: минимальный срок бронирования —{" "}
              <strong>2 суток</strong>
            </span>
          </div>
        </div>
