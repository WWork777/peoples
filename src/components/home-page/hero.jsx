...
// // 				<div className='container max-w-7xl mx-auto h-full px-2.5'>
...
// // 							</span>
// // 						</Link>
// // 						<div className='address'>пгт. Шерегеш, Звездная улица, 8</div>
...
// // 					</header>
// // 					<div className='flex'>
// // 						<div className='w-1/2 pt-[20%] flex flex-col justify-center gap-20'>
// // 							<h1 className='text-[62px] leading-16'>
// // 								Гостевой комплекс «Люди в уюте»
// // 							</h1>
// // 							<h2 className='text-[24px] leading-8'>
// // 								Ваш лучший отдых с видом на заснеженные вершины гор
// // 							</h2>
// // 							<button className='bg-(--accent-color) py-3 px-16 font-medium rounded-[30px] max-w-63.75'>
// // 								Забронировать
// // 							</button>
// // 						</div>
// // 						<div className=' w-1/2 relative'>
// // 							<div className=' absolute bottom-0 left-[50%] flex items-end gap-10'>
// // 								<img
// // 									className='w-20'
...
// // 			<div className='fixed z-10 top-0 right-0 bottom-0 bg-background text-(--accent-color) font-semibold text-lg flex flex-col gap-10 w-90 p-10'>
// // 				{menuLinks.map((item, i) => (
// // 					<Link key={i} href={item.src}>
// // 						{item.title}
// // 					</Link>
// // 				))}
// // 				<RxCross2 size={30} className='absolute top-5 right-5 cursor-pointer' />
// // 			</div>
// // 		</section>
// // 	)
// // }
...
// 							<h1 className='text-[42px] sm:text-[48px] md:text-[62px] leading-tight md:leading-16'>
...
// 							</h2>
// 							<button className='bg-(--accent-color) py-3 px-8 md:px-16 font-medium rounded-[30px] max-w-full w-[320px] mx-auto md:mx-0 md:max-w-63.75 hover:opacity-90 transition-opacity '>
// 								Забронировать
// 							</button>
...
// 			<div
// 				className={`fixed z-30 top-0 right-0 bottom-0 bg-background text-(--accent-color) font-semibold text-lg flex flex-col gap-8 w-full md:w-90 p-10 transition-transform duration-300 ease-out ${
